    ...
    return (
        <header>
            <div className="container-fluid position-relative no-side-padding">
                ...
                <div className="main-menu visible-on-click" id="menu">
                    <li><Link className={"nav-link"} to={"/"}> THE|BLOG </Link></li>
                    <li>
                        <Link className={"nav-link"} to={"/"}>
                            {!isLoading && !user && (
                                <>
                                    <button className="btn btn-dark" onClick={loginWithRedirect}>Войти</button>
                                </>
                            )}
                            {!isLoading && user && (
                                <>
                    ...
                    <li><Link className={"nav-link"} to={"/"}>Домой</Link></li>
                    {isAuthenticated && (
                        <li><Link className="nav-link" to={"/create"}>Создать</Link></li>
                    )}
                </div>
            </div>
        </header>
